...
public class TopRatedViewModel extends AndroidViewModel {
    ...
    public TopRatedViewModel(@NonNull final Application application) {
        super(application);
    ...
    public void performRequest(@NonNull final Application application) {
        ...
        Call<RetroTMDB> call = tmdbWebService.getTopRatedMovies(DEFAULT_PAGE_NUMBER);
    ...
    public MutableLiveData<RetroTMDB> getTopRatedPageMovies() {
        if (movieList == null) {
