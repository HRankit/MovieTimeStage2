...
public class NowPlayingViewModel extends AndroidViewModel {
    ...
    public NowPlayingViewModel(@NonNull final Application application) {
        super(application);
    ...
    public void performRequest(@NonNull final Application application) {
        ...
        Call<RetroTMDB> call = tmdbWebService.getNowPlayingMovies(DEFAULT_PAGE_NUMBER);
    ...
    public MutableLiveData<RetroTMDB> getNowPlayingPageMovies() {
        if (movieList == null) {
