...
public class PopularViewModel extends AndroidViewModel {
    ...
    public PopularViewModel(@NonNull final Application application) {
        super(application);
    ...
    public void performRequest(@NonNull final Application application) {
        ...
        Call<RetroTMDB> call = tmdbWebService.getPopularMovies(DEFAULT_PAGE_NUMBER);
    ...
    public MutableLiveData<RetroTMDB> getPopularFirstPageMovies() {
        if (movieList == null) {
